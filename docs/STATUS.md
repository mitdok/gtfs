...
| RT-4 | ⏳ core store＋API pb配信＋静的index・trip候補・進捗推定・車両位置連動・GPS最寄り停留所絞り込み・候補評価API/Web MVP完了 / 実データ評価未 | TripUpdates生成・静的GTFS突合・VehiclePositionからTripUpdate保存・trip候補品質評価 |
